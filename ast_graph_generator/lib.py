...
def create_ast_graph_from_file(source_file: str, include_paths: list[str], library_paths: list[str]) -> None:
    """
...
def main():
    ...
    logging.info(f"Génération du graph pour le fichier {args.source}")
